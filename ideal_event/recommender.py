...
def euclidean_similarity(datas, person1, person2):

	common_ranked_items = [itm for itm in datas[person1] if itm in datas[person2]]
	rankings = [(datas[person1][itm], datas[person2][itm]) for itm in common_ranked_items]
	distance = [pow(rank[0] - rank[1], 2) for rank in rankings]

	return 1 / (1 + sum(distance))

def pearson_similarity(datas, person1, person2):
	data =datas
...
def euclidean_similarity(datas, person1, person2):
    ...
    common_ranked_items = [
        itm for itm in datas[person1] if itm in datas[person2]]
    rankings = [(datas[person1][itm], datas[person2][itm])
